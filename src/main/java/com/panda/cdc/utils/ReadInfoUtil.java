...
import com.panda.cdc.mq.ThreeConsumer;
import com.panda.cdc.enums.DataBaseEnum;
import com.panda.cdc.enums.OperatorTypeEnum;
...
public class ReadInfoUtil {
    ...
    public static DataChangeInfo getDataChangeInfo(SourceRecord sourceRecord, DataBaseEnum dataBaseEnum) {
        ...
        int eventType = type.equals(CREATE) ? OperatorTypeEnum.INSERT.getOperatorType() : UPDATE.equals(type) ?
                OperatorTypeEnum.UPDATE.getOperatorType() : OperatorTypeEnum.DELETE.getOperatorType();
        ...
        if (eventType == OperatorTypeEnum.DELETE.getOperatorType()) {
